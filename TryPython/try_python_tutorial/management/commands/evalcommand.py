...
class Command(BaseCommand):
	...
	def handle(self, *args, **kwargs):
		...
		pypy_interact = kwargs.get("pypy_interact") #'/home/yori/Downloads/pypy-4.0.1-src/pypy/sandbox/pypy_interact.py'

		tmp_folder = kwargs.get("tmp_folder") #'--tmp=/home/yori/projects/try-python/TryPython/'
		pypy_c = kwargs.get("pypy_c") #'/home/yori/Downloads/pypy-4.0.1-src/pypy/goal/pypy-c'
